...
Хранилище скиллов ограничено уровнем подписки, поэтому скорее всего (если не оформили подписку) при выполнении команд массовой загрузки будет получен - `Push failed: Skill limit reached (10 on free plan)`
