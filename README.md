...
Личное мнение после опробывания каждого варианта
GitLab/GitHub + `npx skills`
1. Сложно для пользователя который не каким образом не связан с программированием
2. При получении списка скиллов репозитория ты сразу получаешь например 1000 доступных что замедляет выбо
---
